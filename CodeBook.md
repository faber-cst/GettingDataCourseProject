...
For the "Getting and Cleaning Data" course project, only the variables with 
Mean and Standard Deviation were selected. This does not include the variables
with "meanFreq". The resulting selection resulted in 66 measurement variables,
and two identification variables (activity and subject)

Final data has the mean of all observations for each activity and subject, 
